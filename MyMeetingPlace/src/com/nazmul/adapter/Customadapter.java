...
import com.nazmul.mymeetingplace.GPSTracker;
import com.nazmul.mymeetingplace.R;
import com.nazmul.util.PlacesModel;

public class Customadapter extends ArrayAdapter<PlacesModel> {
	...
	public Customadapter(Activity context, List<PlacesModel> ePlaces) {
		super(context, R.layout.placeslist, ePlaces);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			vi = mInflater.inflate(R.layout.placeslist, null);
