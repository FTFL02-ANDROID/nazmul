...
public class PublicUniversityListActivity extends ActionBarActivity {
	...
	private void setListData() {
		...
		mPublicUniversityList = publicUniversityData.publicUniversityData();
		for (int i = 0; i < mPublicUniversityList.size(); i++) {
			PublicUniversity mPublicUniversity = mPublicUniversityList.get(i);
